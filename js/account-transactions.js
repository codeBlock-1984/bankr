...
const accountNumberParam = localStorage.getItem('trans-number');
    ...
    if (!response.error) {
      ...
      if (transactionsData[0]) {
        ...
        userTransactions.forEach((transaction) => {
          ...
          sectionHeading.innerHTML = `<a href="accounts.html">${accountnumber}</a>/ &nbsp;&nbsp;Transactions`;
        ...
        sectionHeading.innerHTML = `<a href="accounts.html">${accountNumberParam}</a>/ &nbsp;&nbsp;Transactions`;
